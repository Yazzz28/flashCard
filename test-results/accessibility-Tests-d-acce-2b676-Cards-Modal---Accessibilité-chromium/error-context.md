...
- dialog "Confirmation":
  ...
  - paragraph: Veuillez confirmer votre action
  - paragraph: Êtes-vous sûr de vouloir réinitialiser toutes les cartes révélées ?
  - button "Annuler l'action": Annuler
  - button "Confirmer l'action": Confirmer
```